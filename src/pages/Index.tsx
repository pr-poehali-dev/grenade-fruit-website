...
const TEACHERS = ["Елена Сергеевна", "Александр Валерьевич", "Лариса Ивановна", "Олеся Александровна", "Ирина Олеговна", "Любовь Александровна", "Вадим Игоревич", "Артем Сергеевич"];
...
const SUBJECTS_BY_GRADE: Record<string, string[]> = {
  "1-2": ["Математика", "Русский язык", "Английский язык", "Естествознание", "Урок осознанности", "Классный час", "ЖЗЛ", "ИЗО", "Нейротренинг", "Чтение по программе", "История искусств", "Чтение современной литературы", "ОФП", ...ELECTIVE_SUBJECTS],
  "3-4": ["Математика", "Русский язык", "Чтение", "Биология", "География", "Астрономия", "Физика", "История искусств", "Английский язык", "Классный час", "Урок осознанности", "Нейротренинг", "ОФП", ...ELECTIVE_SUBJECTS],
  "5-6": ["Математика", "Русский язык", "Литература", "Английский язык", "История", "Биология", "География", "Геометрия", "Физика+химия", "Классный час", "Самопознание", "Проект", "Нейротренинг", "ОФП", ...ELECTIVE_SUBJECTS],
  "7":   ["Алгебра", "Геометрия", "Русский язык", "Литература", "Английский язык", "История", "Биология", "География", "Химия", "Физика", "Классный час", "Проект", "Самопознание", "ОФП", ...ELECTIVE_SUBJECTS],
};
