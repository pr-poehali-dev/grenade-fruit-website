...
const SUBJECTS_BY_GRADE: Record<string, string[]> = {
  ...
  "3-4": ["Математика", "Русский язык", "Чтение", "Биология", "География", "Астрономия", "Физика", "История искусств", "Английский язык", "Классный час", "Урок осознанности", "ЖЗЛ", "Нейротренинг", "ОФП", ...ELECTIVE_SUBJECTS],
